...
namespace CloudSalesBusiness
{
    public class ShoppingCartBusiness
    {
        ...
        {
            DataTable dt = ShoppingCartDAL.GetShoppingCart((int)ordertype, userid);
        ...
        {
            return ShoppingCartDAL.AddShoppingCart(productid, detailsid, quantity, unitid, isBigUnit, (int)ordertype, remark, userid, operateip);
        }
