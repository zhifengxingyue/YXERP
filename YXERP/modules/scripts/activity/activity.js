define(function (require, exports, module) {
    ...
    ObjectJS.bindList = function (items) {
        ...
        {
            if (ObjectJS.Params.DisplayType == 1) {
                $(".activityList").html("<tr><td colspan='7' style='padding:15px 0px;'><div style='margin:0px auto; width:300px;'><div class='left'><a href='/Activity/Detail' class='ico-add  mTop4'>添加活动</a></div><div class='clear'></div></div></td></tr>");
            }
            else {
                $(".activityCardList").html("<div style='margin:0px auto; width:300px;'><div class='left'><a href='/Activity/Detail' class='ico-add  mTop4'>添加活动</a></div><div class='clear'></div></div>");
            }
        }
    }
